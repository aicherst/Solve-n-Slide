...
\begin{document}
	...
	As a desirable target particle effects were added to game. They were created with the help of the in-built particle system of Unity. Figure \ref{fig:rocketTrail} shows the propulsion fire and a smoke trail that is left behind for a few seconds. The rocket explodes either after a time limit is reach or as soon as it comes in contact with object (Figure \ref{fig:explosion}). 
	...
	\begin{figure}[H]
		\centering
		\begin{tabular}{ccc}
			\subfloat[Rocket trail fire FX]{\includegraphics[scale=0.5]{images/alpha/RocketTrailFireFX}\label{fig:rocketTrail}}&
			\subfloat[Explosion FX]{\includegraphics[scale=0.5]{images/alpha/ExplosionFX}\label{fig:explosion}}&
			\subfloat[Fireworks FX]{\includegraphics[scale=0.5]{images/alpha/FireworksFX}\label{fig:fireworks}}
		\end{tabular}
		\caption{Second Level}
	\end{figure}
	...
	Another important part of our desirable target was a proper UI. This includes both a nice main menu, as well as a fancy display of ingame information like fuel and health.
	 ...
	 \begin{figure}[H]
	 	\centering
	 	\begin{tabular}{ccc}
	 		\subfloat[Charge icon]{\includegraphics[]{images/alpha/chargeIcon}\label{fig:chargeIcon}}&
	 		\subfloat[Fueltank icon]{\includegraphics[]{images/alpha/fuelTankIcon}\label{fig:fuelTankIcon}}&
	 		\subfloat[Key icon]{\includegraphics[]{images/alpha/keyIcon}\label{fig:keyIcon}}
	 	\end{tabular}
