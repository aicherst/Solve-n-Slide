...
\begin{document}
	...
	\begin{frame}
		...
		\begin{figure}[H]
			\centering
			\begin{tabular}{ccc}
				\subfloat{\includegraphics[scale=0.3]{images/alpha/RocketTrailFireFX}}&
				\subfloat{\includegraphics[scale=0.3]{images/alpha/ExplosionFX}}&
				\subfloat{\includegraphics[scale=0.3]{images/alpha/FireworksFX}}
			\end{tabular}
		\end{figure}
	\end{frame}
\end{document}